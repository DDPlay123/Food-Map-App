 ...
 * 帶有展開收合功能的 TextView
 *
 * 來源：https://github.com/giangpham96/expandable-text
 *
 * 使用方法：
 * ```
 * // 設定最多顯示幾行
 * app:expandableTextViewLimitedMaxLines="3"
 * // 設定原始文字
 * app:expandableTextViewOriginalText="原始文字"
 * // 設定展開按鈕文字
 * app:expandableTextViewExpandAction="展開按鈕文字"
 * // 設定展開按鈕文字顏色
 * app:expandableTextViewExpandActionColor="@color/white"
 * ```
 */
