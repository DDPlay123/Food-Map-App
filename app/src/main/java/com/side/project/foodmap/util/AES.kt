...
object AES {
    ...
    /**
     * Generates SHA256 hash of the secretKey which is used as key
     *
     * @param secretKey used to generated key
     * @return SHA256 of the secretKey
     */
    ...
    /**
     * Encrypt and encode message using 256-bit AES with key generated from secretKey.
     *
     * @param secretKey used to generated key
    ...
    fun encrypt(secretKey: String, message: String): String {
        try {
    ...
    /**
     * Decrypt and decode ciphertext using 256-bit AES with key generated from secretKey
     *
     * @param secretKey                used to generated key
     ...
     */
    @Throws(GeneralSecurityException::class)
    fun decrypt(secretKey: String, base64EncodedCipherText: String): String {
        try {
            val key = generateKey(secretKey)
